...
| ⚠️ 注意每次授权的有效期**最长**可设置为 **365 天，**卖家可在授权时自定义授权到期时间。授权到期后，您需要联系卖家重新授权您的 App。若<u>CB SIP</u>主店铺向应用授予授权，所有 SIP 关联店铺将自动获得该应用授权，但关联店铺的 API 调用权限有限，详情可见<u>FAQ</u><u> 。</u> |
| --- |
## 授权流程
...
注：对于**卖家自研(Seller In House System) App**，直接登陆开放平台> 进入App list>点击 “Authorize”>填写 redirect URL 生成授权链接
...
| auth_type | string | 是 | 需授权的角色类型，枚举值如下：- seller：授权shop或merchant时选择；- supplier：授权供应商时选择（适用于 SCS 用户）；- user：授权用户时选择（适用于直播类型应用，详见<u>https://open.shopee.com/announcements/1190</u> ）。 |
...
1. 若生成授权链接时传入的 redirect_uri（或旧链接中的 redirect）对应的域名与控制台申报域名不一致，将返回错误："The domain of redirect_uri is not consistent with the Redirect URL Domain declared in console"（回调地址域名与控制台申报的回调 URL 域名不一致）。
...
<u>https://open.shopee.com/auth?auth_type=seller&state=test&redirect_uri=https%3A%2F%2Fopen.shopee.com&partner_id=123456&response_type=code</u><u>  </u>
...
<u>https://open.shopee.cn/auth?auth_type=seller&state=test&redirect_uri=https%3A%2F%2Fopen.shopee.com&partner_id=xxxxx&response_type=code</u>
...
<u>https://open.shopee.com.br/auth?auth_type=seller&state=test&redirect_uri=https%3A%2F%2Fopen.shopee.com&partner_id=xxxxx&response_type=code</u>
...
<u>https://open.sandbox.test-stable.shopee.com/auth?auth_type=seller&state=test&redirect_uri=https%3A%2F%2Fopen.shopee.com&partner_id=xxxxx&response_type=code</u>
...
<u>https://open.sandbox.test-stable.shopee.cn/auth?auth_type=seller&state=test&redirect_uri=https%3A%2F%2Fopen.shopee.com&partner_id=xxxxx&response_type=code</u>
...
<u>https://open.sandbox.test-stable.shopee.com.br/auth?auth_type=seller&state=test&redirect_uri=https%3A%2F%2Fopen.shopee.com&partner_id=xxxxx&response_type=code</u>
...
- 如果丢失了最新可用的refresh_token和access_token，请查看此<u>FAQ</u>
#### **GetAccesstoken**
...
路径:<u> https://partner.shopeemobile.com/api/v2/auth/token/get</u>


         <u>https://openplatform.sandbox.test-stable.shopee.sg/api/v2/auth/token/get</u><u> </u>(沙箱测试环境)
...
路径:<u> https://partner.shopeemobile.com/api/v2/auth/access_token/get</u>(生产环境)


         <u>https://</u> <u>https://openplatform.sandbox.test-stable.shopee.sg/api/v2/auth/access_token/get</u>(沙箱测试环境)
...
<u>https://partner.shopeemobile.com/api/v2/auth/token/get?partner_id=1000016&timestamp=1657263479&sign=9c685bc7e4a74e90f45fe1933f1d72b2d9705acda4093a9fb1ec7e2b57ccea2a</u>
...
<u>https://partner.shopeemobile.com/api/v2/auth/access_token/get?partner_id=1000016&timestamp=1657868745&sign=b78833ddcf533903cfae818bbfcf2b6b630e3bc0c941dd65453632f63bf7b495</u>
...
通过以上方式，您可以在四小时内调用RefreshAccessToken接口拿到新的access_token与refresh_token，保持循环调用将能在授权有效期内持续获得可用的access_token与refresh_token。如果丢失了返回的新的refresh_token和access_token，可以参考这篇 <u>FAQ</u><u>。</u>
...
1. 在Platform Partner页面，卖家可查看店铺 / 主账号授权的所有应用及授权到期时间；
...
若授权过程中遇到错误，可参考官方常见问题（<u>FAQ</u>）排查。
